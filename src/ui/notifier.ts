...
import { APP_NAME, APP_USER_MODEL_ID } from "../core/config.js";
...
function showConsoleNotification(title: string, message: string) {
  console.log(`${APP_NAME}: ${title} - ${message}`);
}

function showWindowsToast(title: string, message: string) {
