...
import type { DiscordConnection } from "../core/types.js";
...
async function readConnection(filePath: string): Promise<DiscordConnection> {
...
export async function saveDiscordConnection(connection: DiscordConnection) {
