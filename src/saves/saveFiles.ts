...
export async function getSaveFileInfo(
  file: string,
...
export async function listSaveFiles() {
  try {
    ...
    return saveFiles.filter(
      (file): file is SaveFileInfo => file !== null,
    );
  } catch (error) {
